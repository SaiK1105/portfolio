...
/**
 * /work/vomp — case study for Voice of Monetary Policy, reskinned into
 * the PID 1 — Agent OS look. Every section lives inside window chrome
 ...
 * lib/case-vomp.ts — content unchanged, only the surface reskinned.
 */
...
export const metadata: Metadata = {
  ...
  description: caseMeta.description,
  alternates: { canonical: "/work/vomp/" },
  openGraph: {
    type: "article",
    url: `${site.url}/work/vomp/`,
    title: caseMeta.title,
    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-6xl px-6 pb-14 pt-8 sm:px-8 sm:pb-16 sm:pt-10">
          <Reveal>
            <Window title="vomp — case_study.md" aria-label="Case study overview">
        ...
        <section className={SECTION}>
          <Reveal>
            <Window title="04_limitations.diff" aria-label={lessons.title}>
              <div className="window-pad pb-4">
                <p className="font-mono text-xs uppercase tracking-[0.25em] text-amber">
                  {lessons.kicker}
                </p>
